...
class Graph:
    ...
    def generate_connected_graph(self):
        # Asegura que el grafo sea conexo creando un árbol de expansión
        for i in range(1, self.V):
            weight = random.randint(1, 10)  # Peso aleatorio entre 1 y 10
            self.add_edge(random.randint(0, i - 1), i, weight)

        # Agrega más aristas aleatorias
        for _ in range(self.V * 2):  # Cambia este número para más o menos aristas
...
def main():
    ...
    graph.save_to_file('grafo_conexo_ponderado.txt')
